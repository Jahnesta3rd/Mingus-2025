    ...
    def __init__(self, db_session: Optional[Session] = None):
        if db_session is not None:
            ...
            try:
                ...
                # Defer DB session binding for test environments; tests will patch self.db
...
# Global service instance (lazy/optional). Avoid hard initialization at import time.
try:
    behavioral_trigger_service = BehavioralTriggerService()
except Exception:
    behavioral_trigger_service = None