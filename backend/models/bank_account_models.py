...
# Avoid importing full Plaid models during lightweight tests
try:
    from backend.models.plaid_models import PlaidConnection as BasePlaidConnection
except Exception:  # pragma: no cover
    class BasePlaidConnection:  # type: ignore
        pass
...
class BankAccount(Base):
    ...
    # Additional data (avoid reserved name 'metadata' in SQLAlchemy declarative context)
