...
# Backward-compatibility: expose UserEngagementMetrics here via alias to avoid duplication
from .communication_analytics import UserEngagementMetrics  # noqa: F401
...
"""
Note: User engagement metrics model is defined in
backend.models.communication_analytics.UserEngagementMetrics.
This module intentionally does not redefine that table to avoid
SQLAlchemy MetaData conflicts during test collection.
"""


# Backward-compatibility aliases expected by tests and older code
# Tests import CommunicationDeliveryLog and OptOutRecord
CommunicationDeliveryLog = DeliveryLog
OptOutRecord = OptOutHistory
