...
class PlaidConnectionFlow:
    """Lightweight shim to satisfy tests that import PlaidConnectionFlow.
    The comprehensive implementation exists as BankConnectionFlowService.
    """

    def __init__(self, db_session: Session, access_control_service=None, audit_logging_service=None):
