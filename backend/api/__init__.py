...
Blueprints are imported lazily so importing a single submodule
(e.g. ``backend.api.daily_outlook_api``) does not pull in every
endpoint module and their import-time database side effects.
"""
