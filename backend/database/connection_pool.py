...
class ConnectionPoolManager:
    ...
    def _setup_pool_events(self, engine: Engine, pool_name: str):
        ...
        # 'disconnect' Engine event is not available in SQLAlchemy 2.x; guard registration
        try:
            ...
            logger.debug("Skipping 'disconnect' engine event registration for pool events (unsupported)")
