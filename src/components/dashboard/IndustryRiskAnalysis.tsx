    ...
    return (
      <div className={`bg-gray-900 rounded-lg p-6 ${className}`}>
        <div className="text-center">
          ...
          <h3 className="text-lg font-semibold text-white mb-2">Analysis Unavailable</h3>
      ...
      <div className="p-6 border-b border-gray-800">
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h2 className="text-xl font-bold text-white">{riskData.industry_name}</h2>
              <p className="text-gray-400 text-sm">NAICS: {riskData.naics_code}</p>
            </div>
          </div>
          <div className="text-right">
            <div className={`inline-flex items-center px-3 py-1 rounded-full text-sm font-medium ${getRiskBgColor(riskData.overall_risk_score)} ${getRiskColor(riskData.overall_risk_score)}`}>
      ...
      <div className="p-6">
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="bg-gray-800 rounded-lg p-4">
                ...
                <div className={`text-sm ${getRiskColor(riskData.overall_risk_score)}`}>
              ...
              <div className="bg-gray-800 rounded-lg p-4">
                <div className="flex items-center space-x-3 mb-3">
                  ...
                  <h3 className="font-semibold text-white">Job Growth</h3>
                </div>
              ...
              <div className="bg-gray-800 rounded-lg p-4">
                <div className="flex items-center space-x-3 mb-3">
                  ...
                  <h3 className="font-semibold text-white">Automation Risk</h3>
                </div>
                <div className="text-2xl font-bold text-white mb-1">
        ...
        {activeTab === 'employment' && (
          <div className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-gray-800 rounded-lg p-4">
                <h3 className="font-semibold text-white mb-4">Employment Trends</h3>
              ...
              <div className="bg-gray-800 rounded-lg p-4">
                <h3 className="font-semibold text-white mb-4">Growth Analysis</h3>
                <div className="space-y-4">
                  <div>
        ...
        {activeTab === 'automation' && (
          <div className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-gray-800 rounded-lg p-4">
                <h3 className="font-semibold text-white mb-4">Automation Risk Assessment</h3>
                <div className="space-y-4">
                  <div>
                    <div className="flex justify-between items-center mb-2">
              ...
              <div className="bg-gray-800 rounded-lg p-4">
                <h3 className="font-semibold text-white mb-4">Task Analysis</h3>
                <div className="space-y-4">
                  <div>
                    <div className="flex justify-between items-center mb-2">
            ...
            <div className="bg-gray-800 rounded-lg p-4">
              <h3 className="font-semibold text-white mb-4">Mitigation Strategies</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        {activeTab === 'economic' && (
          <div className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="bg-gray-800 rounded-lg p-4">
                <h3 className="font-semibold text-white mb-4">Economic Sensitivity</h3>
                <div className="space-y-4">
                  <div>
                    <div className="flex justify-between items-center mb-2">
              ...
              <div className="bg-gray-800 rounded-lg p-4">
                <h3 className="font-semibold text-white mb-4">GDP Correlation</h3>
                <div className="text-center">
        ...
        {activeTab === 'geographic' && (
          <div className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-gray-800 rounded-lg p-4">
                <h3 className="font-semibold text-white mb-4">Geographic Factors</h3>
                <div className="space-y-4">
                  <div>
                    <div className="flex justify-between items-center mb-2">
        ...
        {activeTab === 'career' && (
          <div className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-gray-800 rounded-lg p-4">
                <h3 className="font-semibold text-white mb-4">Career Advancement Metrics</h3>
                <div className="space-y-4">
                  <div>
                    <div className="flex justify-between items-center mb-2">
              ...
              <div className="bg-gray-800 rounded-lg p-4">
                <h3 className="font-semibold text-white mb-4">Advancement Category</h3>
                <div className="text-center">
            ...
            <div className="bg-gray-800 rounded-lg p-4">
              <h3 className="font-semibold text-white mb-4">Career Recommendations</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
