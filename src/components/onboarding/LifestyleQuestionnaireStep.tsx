    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-pink-50 to-purple-100 flex items-center justify-center p-4">
        <div className="max-w-2xl w-full bg-white rounded-2xl shadow-xl p-8 text-center">
          ...
          <h1 className="text-2xl font-bold text-gray-900 mb-4" className="text-4xl font-bold text-gray-900 mb-6">
      ...
      <div className="bg-white shadow-sm border-b border-gray-200">
        <div className="max-w-4xl mx-auto px-4 py-4">
          <div className="flex items-center justify-between mb-2">
            <h2 className="text-xl font-semibold text-gray-900" className="text-2xl font-semibold text-gray-800 mb-4">Lifestyle Assessment</h2>
        ...
        <div className="bg-white rounded-xl shadow-sm p-8 mb-6">
          <div className="text-center mb-8">
            ...
            <div className="bg-pink-50 border border-pink-200 rounded-lg p-4">
              <h3 className="font-semibold text-pink-800 mb-2" className="text-xl font-semibold text-gray-800 mb-3">This assessment covers:</h3>
