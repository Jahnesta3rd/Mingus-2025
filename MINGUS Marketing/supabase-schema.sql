-- Supabase Database Schema for MINGUS Assessment Workflow
...
CREATE TYPE user_segment AS ENUM (
  stress-free,relationship-spender', 
  emotional-manager',
  crisis-mode'
);
...
CREATE TABLE assessment_questions (
  id UUID PRIMARY KEY DEFAULT uuid_generate_v4uestion_id VARCHAR(50 UNIQUE NOT NULL,
  question_text TEXT NOT NULL,
  question_type VARCHAR(20OT NULL, -- radio', 'checkbox,rating',text', 'dropdown options JSONB, -- For multiple choice questions
...
('q1',How often do you lose sleep thinking about money?', 'radio', 
  [{"value:never, label: Never (0 points)"}, {"value":monthly", "label: "Once a month (1 point)"},[object Object]value": weekly", label":Weekly (2 points)"}, {value": multiple_weekly", label: Multiple times per week (3 points)"}, {"value:daily, label: Daily (4 points)}],
  01 2, 34]', 1q2In the past month, how often have you spent money you didn''t plan to spend because of: (Select all that apply)?', checkbox,[{"value:impress_date",label": "Wanting to impress someone on a date (2 points)"}, {"value": stress_shopping", label: "Stress-shopping after an argument with family/partner (3 points)"}, {"value": keep_up_friends",label": "Keeping up with friends'' social activities (2 points)"}, {"value:guilt_family, : "Guilt purchases for family members (2 points)"}, {"value":emotional_eating", "label":Emotional eating/drinking after relationship stress (2 points)"},[object Object]value": none",label": None of the above (0 points)}],
  [2, 32 2, 20, 2),
(, 'How comfortable are you discussing money with: (Rate 1-5: 1=Very Uncomfortable, 5Very Comfortable)?', 'rating,
  {"value":partner", "label": "Your romantic partner"},[object Object]value": family", "label:Your family"}, {"value":friends, l:Close friends}],
  12 3, 45, 3),
('q4', 'When you're stressed about money, who do you talk to?, adio,
  {"value":partner", "label": My partner/spouse"},[object Object]value": family, el": "Close family members"}, {"value":friends",label": "Friends},[object Object]value": myself", "label": "I keep it to myself"}, {"value:professional", "label:A professional (therapist, financial advisor, etc.)}],
  12 3, 454, 'Which situation most often leads to unplanned spending?, adio,[{"value": "work_stress,labelAfter a stressful day at work"}, {value": argument", "label": "Following an argument with someone close to me},[object Object]value": lonely", label": When I feeling lonely or disconnected"}, {"value: omparison", "label": When I see others enjoying things I can''t afford"}, {"value": "celebration", label":When I''m trying to celebrate or connect with others}],
  2, 2]', 5);
