  ...
  return (
    ...
    >
      ...
      {error && (
        <div 
          id={errorId}
          className="absolute top-full left-0 right-0 mt-2 text-base text-red-500 text-center"
          role="alert"
          aria-live="polite"
        >
          {error}
      ...
      <div 
        id={descriptionId}
        className="absolute top-full left-0 right-0 mt-8 text-base text-gray-400 text-center"
      >
