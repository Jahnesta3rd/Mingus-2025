// cypress/e2e/health_onboarding.cy.js
...
describe('Health Onboarding Flow', () => {
  ...
  it('should complete 4-step onboarding', () => {
  ...
  it('should handle onboarding step navigation', () => {
    cy.visit(`${baseUrl}/api/health/onboarding`)
  ...
  it('should validate onboarding form data', () => {
    cy.visit(`${baseUrl}/api/health/onboarding`)
  ...
  it('should test onboarding with different user preferences', () => {
  ...
  it('should test skip functionality', () => {
    cy.visit(`${baseUrl}/api/health/onboarding`)
  ...
  it('should test learn more functionality', () => {
    cy.visit(`${baseUrl}/api/health/onboarding`)
