      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="bg-white rounded-xl shadow-sm p-6 mb-8">
          <div className="flex items-center justify-between mb-4">
            ...
            <span className="text-base text-gray-500">Step 2 of 7</span>
          </div>
        ...
        <div className="bg-white rounded-xl shadow-sm p-8">
          ...
          First Name *
                  ...
                  {validationErrors.first_name && (
                    <p className="text-red-500 text-base mt-1">{validationErrors.first_name}</p>
                  )}
                </div>
          ...
          Last Name *
                  ...
                  {validationErrors.last_name && (
                    <p className="text-red-500 text-base mt-1">{validationErrors.last_name}</p>
                  )}
                </div>
          ...
          Age Range *
                ...
                {validationErrors.age_range && (
                  <p className="text-red-500 text-base mt-1">{validationErrors.age_range}</p>
                )}
              </div>
            </div>
          ...
          Zip Code *
                  ...
                  {validationErrors.zip_code && (
                    <p className="text-red-500 text-base mt-1">{validationErrors.zip_code}</p>
                  )}
                </div>
          ...
          State *
                  ...
                  {validationErrors.location_state && (
                    <p className="text-red-500 text-base mt-1">{validationErrors.location_state}</p>
                  )}
                </div>
          ...
          City *
                  ...
                  {validationErrors.location_city && (
                    <p className="text-red-500 text-base mt-1">{validationErrors.location_city}</p>
                  )}
                </div>
              </div>
