...
class StripeConfig:
    """Comprehensive Stripe configuration management."""
    ...
    def __init__(self, environment: Optional[str] = None):
        ...
        """
        self.environment = environment or os.environ.get('STRIPE_ENVIRONMENT', 'test')
    ...
    def _load_test_configuration(self):
        ...
        self.api_key = os.environ.get('STRIPE_TEST_SECRET_KEY')
        self.publishable_key = os.environ.get('STRIPE_TEST_PUBLISHABLE_KEY')
        self.webhook_secret = os.environ.get('STRIPE_TEST_WEBHOOK_SECRET')
        
        # Test webhook endpoint
        self.webhook_endpoint = os.environ.get(
        ...
        # Test price IDs
        self.price_ids = {
            'budget_monthly': os.environ.get('STRIPE_TEST_BUDGET_MONTHLY_PRICE_ID'),
            'budget_yearly': os.environ.get('STRIPE_TEST_BUDGET_YEARLY_PRICE_ID'),
            'mid_tier_monthly': os.environ.get('STRIPE_TEST_MID_TIER_MONTHLY_PRICE_ID'),
            'mid_tier_yearly': os.environ.get('STRIPE_TEST_MID_TIER_YEARLY_PRICE_ID'),
            'professional_monthly': os.environ.get('STRIPE_TEST_PROFESSIONAL_MONTHLY_PRICE_ID'),
            'professional_yearly': os.environ.get('STRIPE_TEST_PROFESSIONAL_YEARLY_PRICE_ID'),
        }
        
        # Test-specific settings
        self.currency = os.environ.get('STRIPE_TEST_CURRENCY', 'usd')
        self.trial_days = int(os.environ.get('STRIPE_TEST_TRIAL_DAYS', '7'))
        self.grace_period_days = int(os.environ.get('STRIPE_TEST_GRACE_PERIOD_DAYS', '3'))
        
        # Test logging
        self.log_level = os.environ.get('STRIPE_TEST_LOG_LEVEL', 'DEBUG')
        self.enable_debug = os.environ.get('STRIPE_TEST_DEBUG', 'true').lower() == 'true'
        
    def _load_live_configuration(self):
        """Load live environment configuration."""
        self.api_key = os.environ.get('STRIPE_LIVE_SECRET_KEY')
        self.publishable_key = os.environ.get('STRIPE_LIVE_PUBLISHABLE_KEY')
        ...
        # Live price IDs
        self.price_ids = {
            'budget_monthly': os.environ.get('STRIPE_LIVE_BUDGET_MONTHLY_PRICE_ID'),
            'budget_yearly': os.environ.get('STRIPE_LIVE_BUDGET_YEARLY_PRICE_ID'),
            'mid_tier_monthly': os.environ.get('STRIPE_LIVE_MID_TIER_MONTHLY_PRICE_ID'),
            'mid_tier_yearly': os.environ.get('STRIPE_LIVE_MID_TIER_YEARLY_PRICE_ID'),
            'professional_monthly': os.environ.get('STRIPE_LIVE_PROFESSIONAL_MONTHLY_PRICE_ID'),
            'professional_yearly': os.environ.get('STRIPE_LIVE_PROFESSIONAL_YEARLY_PRICE_ID'),
        }
        
        # Live-specific settings
        self.currency = os.environ.get('STRIPE_LIVE_CURRENCY', 'usd')
        self.trial_days = int(os.environ.get('STRIPE_LIVE_TRIAL_DAYS', '7'))
        self.grace_period_days = int(os.environ.get('STRIPE_LIVE_GRACE_PERIOD_DAYS', '3'))
        
        # Live logging
        self.log_level = os.environ.get('STRIPE_LIVE_LOG_LEVEL', 'INFO')
        self.enable_debug = os.environ.get('STRIPE_LIVE_DEBUG', 'false').lower() == 'true'
